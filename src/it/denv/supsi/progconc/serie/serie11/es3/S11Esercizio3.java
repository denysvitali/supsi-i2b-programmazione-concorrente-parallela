package it.denv.supsi.progconc.serie.serie11.es3;
...
/*
	Non posso svolgere l'es. 3 perché la funzionalità di Mission Control
	non è disponibile in OpenJDK.
 */
...
public class S11Esercizio3 extends JPanel {
	...
	public static void main(final String[] args) {
		...
		final S11Esercizio3 content = new S11Esercizio3();
